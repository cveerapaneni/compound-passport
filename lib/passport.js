...
exports.init = function (compound) {
    ...
    var conf = requireIfExists(compound, 'passport.js') || requireIfExists(compound, 'passport.coffee') || requireIfExists(compound, 'passport.yml');
	if (!conf) {
...
exports.loadUser = function (u) {
    if (!u.localFindOrCreate) {
        u.localFindOrCreate = require('./user.js').localFindOrCreate;
    }
    Object.keys(exports.strategies).forEach(function (str) {
